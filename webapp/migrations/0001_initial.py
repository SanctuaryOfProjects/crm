    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.employee', verbose_name='Сотрудник')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.employee', verbose_name='Сотрудник')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.employee', verbose_name='Сотрудник')),
                ('store', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='webapp.store', verbose_name='Торговая точка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.store', verbose_name='Торговая точка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.brand', verbose_name='Бренд')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.category', verbose_name='Категория')),
                ('producer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.producer', verbose_name='Поставщик')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='received_messages', to='webapp.employee', verbose_name='Получатель')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sent_messages', to='webapp.employee', verbose_name='Отправитель')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='employee',
            name='store',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.store', verbose_name='Торговая точка'),
        ),
        migrations.CreateModel(
            name='Decrease',
            fields=[
                ...
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.partner', verbose_name='Клиент')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_price', models.DecimalField(decimal_places=0, max_digits=10, verbose_name='Общая цена')),
                ('date', models.DateField(verbose_name='Дата')),
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.producer', verbose_name='Поставщик')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.product', verbose_name='Товар')),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.store', verbose_name='Торговая точка')),
            ],
            options={
